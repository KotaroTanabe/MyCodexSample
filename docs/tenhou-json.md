...
## Converting to a Tenhou replay URL

Stringify the JSON without spaces and URL‑encode it. Append the result
after `#json=` to open it in Tenhou:

```
https://tenhou.net/6/#json=<encoded-json>&ts=0
```

The example above becomes:

```
https://tenhou.net/6/#json=%7B%22title%22%3A%5B%22%22,%22%22%5D...%7D&ts=0
```
